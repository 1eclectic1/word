...
<?php if (!empty($recommendations) && !empty($answers)): ?>
    ...
    <div id="predictions-content">
        ...
        <div class="columns-wrapper">
            ...
            <div class="suggestion-column">
                ...
                <!-- FIX: Loop over your sliced $topProbes array instead of the raw global payload -->
            ...
            <div class="suggestion-column">
                ...
                <!-- FIX: Loop over your sliced $topAnswers array instead of the raw global payload -->
